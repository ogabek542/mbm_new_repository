              ...
              {orderDetails?.cartItems && orderDetails?.cartItems.length > 0
                ? orderDetails?.cartItems.map((item) => (
                    <li className="flex items-center justify-between">
                      ...
                      <span>{t("quantity_text")}: {item.quantity}</span>
                      <span>{t("price_text")}: ${item.price}</span>
                    </li>
                  ))
                : null}
            </ul>
            ...
            formControls={[
              {
                ...
                options: [
                  { id: "pending", label: t("pending_text") },
                  { id: "inProcess", label: t("in_process_text") },
                  { id: "inShipping", label: t("in_shipping_text") },
                  { id: "delivered", label: t("delivered_text") },
                  { id: "rejected", label: t("rejected_text") },
                ],
              },
            ]}
            formData={formData}
            setFormData={setFormData}
            buttonText={t("update_order_status_text")}
